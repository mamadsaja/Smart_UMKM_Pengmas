...
<footer class="bg-gray-900 w-full mt-16">
  <div class="w-full max-w-[85rem] py-16 px-4 sm:px-6 lg:px-8 mx-auto">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-2 gap-12">
      ...
      <div class="col-span-1">
        <div class="bg-gray-800 rounded-2xl overflow-hidden h-full shadow-xl">
    ...
    <div class="mt-16 pt-8 border-t border-gray-800">
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
        <div class="col-span-1">
          <a class="flex-none text-xl font-semibold text-white focus:outline-hidden focus:opacity-80" href="#" aria-label="Brand">Smart UMKM</a>
          <p class="mt-3 text-sm text-gray-400">Mendukung pertumbuhan UMKM lokal melalui digitalisasi dan pemasaran online.</p>
        </div>
        
        <!-- Kolom menu footer -->
        <div class="col-span-1">
          <h4 class="font-semibold text-gray-100">Layanan</h4>
          <div class="mt-3 grid space-y-3">
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200" href="#">Toko Online</a></p>
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200" href="#">Pelatihan Digital</a></p>
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200" href="#">Konsultasi Bisnis</a></p>
          </div>
        </div>
        ...
        <div class="col-span-1">
          ...
          <div class="mt-3 grid space-y-3">
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200" href="#">Tentang Kami</a></p>
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200" href="#">Blog</a></p>
            <p><a class="inline-flex gap-x-2 text-gray-400 hover:text-gray-200 focus:outline-hidden focus:text-gray-200" href="#">Karir</a> <span class="inline-block ms-1 text-xs bg-blue-700 text-white py-1 px-2 rounded-lg">We're hiring</span></p>
          </div>
        </div>
        
        <div class="col-span-1">
          <h4 class="font-semibold text-gray-100">Berlangganan</h4>
          <form>
            <div class="mt-4 flex flex-col items-center gap-2 sm:flex-row sm:gap-3 bg-gray-800 rounded-lg p-2">
              <div class="w-full">
                <label for="hero-input" class="sr-only">Email</label>
                <input type="text" id="hero-input" name="hero-input" class="py-2.5 px-4 block w-full bg-gray-700 border-transparent rounded-lg sm:text-sm text-white focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none" placeholder="Email Anda">
              </div>
            ...
            <p class="mt-3 text-sm text-gray-400">
              Dapatkan info terbaru dan promo menarik.
            </p>
          </form>
        </div>
      </div>
